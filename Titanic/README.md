...
Note: In addition to EDA, you'll also be practicing using markdown! The questions are provided for you here in the readme - please copy them over to your notebook.
...
1. In each of the following sections, copy the question, then answer the question with your own code.
